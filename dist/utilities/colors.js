...
export const purple = (str) => {
    return rgb(201, 151, 233, str);
};
export const lightPurple = (str) => {
...
export const json = (obj, params) => {
    const { space = 2, colors = {
        bracket: [230, 240, 255],
        comma: [230, 240, 255],
        key: [204, 224, 252],
        string: [245, 245, 205],
...
export const styledText = (baseColor = (s) => s, ctx = colorMap) => (strings, ...values) => {
